...
def setup_contexts(app : Flask):
    ...
    def inject_assets():
        ...
        features = {
            "dataTable" : {
                "css": url_for('static', filename='admin/css/plugins/dataTables.bootstrap.css'),
                "scripts":[
                    url_for('static', filename='admin/js/plugins/dataTable/dataTables.js'),
                    url_for('static', filename='admin/js/plugins/dataTable/dataTables.bootstrap5.js'),
                    url_for('static', filename='admin/js/plugins/dataTable/dataTables.buttons.min.js'),
                    url_for('static',filename="admin/js/plugins/dataTable/jszip.min.js"),
                    url_for('static',filename="admin/js/plugins/dataTable/pdfmake.min.js"),
                    url_for('static',filename="admin/js/plugins/dataTable/vfs_fonts.js"),
                    url_for('static', filename='admin/js/plugins/dataTable/buttons.html5.min.js'),
                    url_for('static', filename='admin/js/plugins/dataTable/buttons.print.min.js'),                    
                ]
            }
        } 
        ...
        def get_user_avatar(user_id):
            if user_id:
                ...
                return url_for('static', filename='admin/images/avatar/' + user.user_avatar)
        
        return dict( assets=g.assets, current_year=current_year, title=title, get_user_avatar=get_user_avatar)
