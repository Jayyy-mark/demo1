/*<!--========================================
    FETCH COLLABORATION UNIVERSITY API (DATA)
=========================================-->*/
import { api } from "../utils/api.js";

const collaborationAPI = {
    async getCollaborations() {
        const res = await api.get("/frontend/collaboration/university");
...
const collaborationUI = {
    ...
    renderCollaborations(collaborations) {
        ...
        const cards = collaborations.map((c, index) => `
            ...
            <div class="partner-item ${index >= 3 ? 'hidden' : ''} flex flex-col justify-between bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl hover:shadow-blue-500/50 border-2 border-gray-200 hover:border-blue-500 hover:-translate-y-1.5 transition-all duration-300 transform">
                <div>
                    ...
                    <!-- Partner Info -->
                    <h3 class="text-xl text-center font-bold text-slate-800 mb-2 hover:text-blue-800 transition-colors">${c.organization_name}</h3>
